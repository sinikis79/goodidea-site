...
const services = [
  {
    title: "우울증·공황장애",
    description: "가라앉은 기분과 갑작스러운 불안, 두근거림이 반복될 때 함께 살핍니다.",
    keywords: ["우울감", "무기력", "공황", "두근거림"],
  ...
  {
    title: "불안·강박 증상",
    description: "반복되는 걱정과 확인 행동, 사람 앞에서의 긴장을 차분히 다룹니다.",
    keywords: ["강박", "사회불안", "확인행동", "긴장"],
  ...
  {
    title: "기억력·주의집중",
    description: "잦은 깜빡임과 집중력 저하가 일상에 미치는 영향을 세심하게 평가합니다.",
    keywords: ["건망증", "성인ADHD", "집중력", "일상관리"],
  ...
  {
    title: "불면·스트레스",
    description: "잠들기 어려움과 피로감, 긴장된 생활 리듬을 함께 점검합니다.",
    keywords: ["불면증", "스트레스", "피로감", "수면리듬"],
  ...
  {
    title: "신체화 증상",
    description: "검사상 큰 이상이 없어도 지속되는 몸의 불편감을 마음과 함께 살핍니다.",
    keywords: ["신체증상", "두통", "소화불편", "가슴답답함"],
  ...
  {
    title: "식이 문제",
    description: "식사 패턴과 체중 걱정 뒤에 있는 감정의 흐름을 함께 이해합니다.",
    keywords: ["식이장애", "폭식", "식욕변화", "체중걱정"],
